...
.. only:: html
    ...
    .. figure:: /_uml/class_fuzzy_dl_owl2_fuzzydl_classification_node_ClassificationNode.png
       :alt: UML Class Diagram for ClassificationNode
       :align: center
       :width: 100%
       :class: uml-diagram

       UML Class Diagram for **ClassificationNode**

.. only:: latex

    .. figure:: /_uml/class_fuzzy_dl_owl2_fuzzydl_classification_node_ClassificationNode.pdf
       :alt: UML Class Diagram for ClassificationNode
       :align: center
       :width: 11.1cm
       :class: uml-diagram
