...
.. only:: html
    ...
    .. figure:: /_uml/class_fuzzy_dl_owl2_fuzzyowl2_fuzzyowl2_to_fuzzydl_FuzzyOwl2ToFuzzyDL.png
...
.. py:class:: FuzzyOwl2ToFuzzyDL(input_file: str, output_file: str, base_iri: str = 'http://www.semanticweb.org/ontologies/fuzzydl_ontology#')
   ...
   .. autoapi-inheritance-diagram:: fuzzy_dl_owl2.fuzzyowl2.fuzzyowl2_to_fuzzydl.FuzzyOwl2ToFuzzyDL
      :parts: 1
      :private-bases:
   ...
   .. py:method:: __get_set_name(curr_set: set) -> str
   ...
   .. py:method:: __is_integer_datatype(d: Union[pyowl2.base.datatype.OWLDatatype, pyowl2.literal.literal.OWLLiteral]) -> bool
   ...
   .. py:method:: __is_real_datatype(d: Union[pyowl2.base.datatype.OWLDatatype, pyowl2.literal.literal.OWLLiteral]) -> bool
   ...
   .. py:method:: __write(line: str) -> None
   ...
   .. py:method:: get_bottom_data_property_name() -> Optional[str]
   ...
   .. py:method:: get_bottom_object_property_name() -> Optional[str]
   ...
   .. py:method:: get_short_name(s: Union[pyowl2.abstracts.entity.OWLEntity, str]) -> str
   ...
   .. py:method:: get_top_data_property_name() -> Optional[str]
   ...
   .. py:method:: get_top_object_property_name() -> Optional[str]
   ...
   .. py:method:: write_functional_data_property_axiom(p: pyowl2.abstracts.data_property_expression.OWLDataPropertyExpression) -> None
