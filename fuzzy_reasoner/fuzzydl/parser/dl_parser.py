...
from fuzzy_reasoner.fuzzydl.modifier.triangular_modifier import \
    TriangularModifier
from fuzzy_reasoner.fuzzydl.query.all_instances_query import AllInstancesQuery
from fuzzy_reasoner.fuzzydl.query.bnp_query import BnpQuery
from fuzzy_reasoner.fuzzydl.query.defuzzify.lom_defuzzify_query import \
    LomDefuzzifyQuery
from fuzzy_reasoner.fuzzydl.query.defuzzify.mom_defuzzify_query import \
    MomDefuzzifyQuery
from fuzzy_reasoner.fuzzydl.query.defuzzify.som_defuzzify_query import \
    SomDefuzzifyQuery
from fuzzy_reasoner.fuzzydl.query.kb_satisfiable_query import \
    KbSatisfiableQuery
from fuzzy_reasoner.fuzzydl.query.max.max_instance_query import \
    MaxInstanceQuery
from fuzzy_reasoner.fuzzydl.query.max.max_query import MaxQuery
from fuzzy_reasoner.fuzzydl.query.max.max_related_query import MaxRelatedQuery
from fuzzy_reasoner.fuzzydl.query.max.max_satisfiable_query import \
    MaxSatisfiableQuery
from fuzzy_reasoner.fuzzydl.query.max.max_subsumes_query import \
    MaxSubsumesQuery
from fuzzy_reasoner.fuzzydl.query.min.min_instance_query import \
    MinInstanceQuery
from fuzzy_reasoner.fuzzydl.query.min.min_query import MinQuery
from fuzzy_reasoner.fuzzydl.query.min.min_related_query import MinRelatedQuery
from fuzzy_reasoner.fuzzydl.query.min.min_satisfiable_query import \
    MinSatisfiableQuery
from fuzzy_reasoner.fuzzydl.query.min.min_subsumes_query import \
    MinSubsumesQuery
from fuzzy_reasoner.fuzzydl.query.query import Query
from fuzzy_reasoner.fuzzydl.util import constants, utils
from fuzzy_reasoner.fuzzydl.util.config_reader import ConfigReader
from fuzzy_reasoner.fuzzydl.util.constants import (ConceptType, FuzzyDLKeyword,
