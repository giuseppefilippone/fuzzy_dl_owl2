...
class DegreeExpression(Degree):
    ...
    def __init__(self, expr: Expression) -> None:
        """
        Initializes a new instance of the DegreeExpression class by storing the provided symbolic expression. The constructor accepts a single argument, `expr`, which is expected to be an instance of the Expression class, and assigns it to the `expr` attribute of the object. This method performs no validation or transformation on the input, meaning that if an object incompatible with subsequent operations is passed, errors may occur later during evaluation or manipulation. The primary side effect of this method is the mutation of the instance's internal state to hold the reference to the input expression.

        :param expr: The expression object to be stored or represented by this instance.
        :type expr: Expression
        """
